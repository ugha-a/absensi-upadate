                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="number" id="no_telp" class="form-control" name="no_telp" placeholder="Masukkan No Telepon" required>
                                        <div class="form-control-icon">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" id="mapel" class="form-control" name="mapel" placeholder="Masukkan Mata Pelajaran" required>
                                        <div class="form-control-icon">

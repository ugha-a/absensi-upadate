    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" method="POST" action="{{ route('mapel.update', $mapel->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" id="jadwal_mapel" class="form-control" name="jadwal_mapel"
                                                value="{{ old('jadwal_mapel', $mapel->jadwal_mapel) }}"
                                                placeholder="Masukkan Jadwal Mata Pelajaran" required>
                                            <div class="form-control-icon">
